      ...
      <div class="model-one">
        <el-form :model="formAddOne">
          <el-row>
            ...
            <!-- 按钮 -->
            <!-- <el-col :span="24" class="but-cen">
              <el-button @click="toStorage">本地暂存</el-button>
              <el-button type="primary">部分提交</el-button>
            </el-col> -->
          </el-row>
        </el-form>
      </div>
      <!-- 第二层 -->
      <!-- <div class="model-one model-two">
        <el-form :model="formAddTwo">
          <el-row>
            <el-col :span="12">
              <el-form-item label="内容类别" :label-width="formLabelWidth">
                <el-select v-model="formAddTwo.type" clearable placeholder="请选择">
                  <el-option
                    v-for="item in optionsType"
                    :key="item.value"
                    :label="item.label"
            ...
            <el-col :span="12" class="but-right">
